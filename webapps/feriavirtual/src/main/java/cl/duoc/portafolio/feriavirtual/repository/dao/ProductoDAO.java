...
public class ProductoDAO implements IProductoDAO{
	...
	@Override
	public List<Producto> search(List<SearchCriteria> params, Pageable pageable) {
		final CriteriaBuilder builder = entityManager.getCriteriaBuilder();
		final CriteriaQuery<Producto> query = builder.createQuery(Producto.class);
		final Root<Producto> root = query.from(Producto.class);
