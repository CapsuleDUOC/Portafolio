...
public class VehiculoDAO implements IVehiculoDAO{
	...
	@Override
	public List<Vehiculo> search(List<SearchCriteria> params, Pageable pageable) {

		final CriteriaBuilder builder = entityManager.getCriteriaBuilder();
		final CriteriaQuery<Vehiculo> query = builder.createQuery(Vehiculo.class);
		final Root<Vehiculo> root = query.from(Vehiculo.class);
