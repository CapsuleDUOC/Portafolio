...
public class DireccionDAO implements IDireccionDAO{
	...
	@Override
	public List<Direccion> search(List<SearchCriteria> params, Pageable pageable) {
		final CriteriaBuilder builder = entityManager.getCriteriaBuilder();
		final CriteriaQuery<Direccion> query = builder.createQuery(Direccion.class);
		final Root<Direccion> root = query.from(Direccion.class);
