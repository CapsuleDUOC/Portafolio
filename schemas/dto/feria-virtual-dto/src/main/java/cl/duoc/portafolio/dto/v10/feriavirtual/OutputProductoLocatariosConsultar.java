 ...
 *       &lt;sequence&gt;
 *         &lt;element name="registro" type="{http://duoc.cl/portafolio/dto/v10/FeriaVirtual}ProductoLocatarioType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class OutputProductoLocatariosConsultar {
    ...
    protected List<ProductoLocatarioType> registro;
     ...
     * 
     */
    public List<ProductoLocatarioType> getRegistro() {
        if (registro == null) {
            registro = new ArrayList<ProductoLocatarioType>();
        }
