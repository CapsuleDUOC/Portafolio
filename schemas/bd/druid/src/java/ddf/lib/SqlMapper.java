...
public class SqlMapper
{
	...
	public static SqlType map(Object id, String dbType, Object decimals, Connection conn)
	{
		...
		//--- try to remap DBMS specific types
		
		if (isOracle(conn))
		{
			//--- in case of oracle, the date is converted into a timestamp

			if (sqlType.iId == Types.DATE)
				return mapId("" + Types.TIMESTAMP);
		}
	...
	{
		String fullClass = conn.getClass().getName();

		return (fullClass.indexOf("oracle.") != -1);
	}
}
