																	...
																	TreeViewSelListener
{
	...
	private TriggerEntity  trigNode;
	...
	public TriggerView()
	{
		...
		tree.setRootNode(new TriggerEntity());
	...
	public JPopupMenu generate(TreeViewNode treeNode)
	{
		...
		if (treeNode != null)
			popup.add(MenuFactory.createItem("pop_drop", "Drop trigger", this));
		...
		ModuleManager.addTreeNodeModules(popup, treeNode, this, TreeNodeModule.JDBC_TRIGGER);
	...
	protected void pop_drop()
	{
		...
		TriggerEntity node = (TriggerEntity) tree.getSelectedNode();
	...
	public void setTriggerNode(TriggerEntity node)
	{
