...
public class FieldNodeV extends AbstractNodeV
{
	...
	public FieldNodeV(AbstractNode node) { super(node); }
	...
	public boolean getIsPrimaryKey(){ return DataLib.isPrimaryKey(getFieldNode()); }
	public boolean getIsNotNull()   { return DataLib.isNotNull(getFieldNode());    }
	public boolean getIsUnique()    { return DataLib.isUnique(getFieldNode());     }
	public boolean getIsForeignKey(){ return getFieldNode().isFkey();              }
