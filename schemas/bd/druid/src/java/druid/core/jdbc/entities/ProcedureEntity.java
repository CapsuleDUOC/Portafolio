...
public class ProcedureEntity extends CodingEntity
{
	...
	public ProcedureEntity(JdbcConnection conn, String name, String rems)
	{
	...
	protected void loadInfoI() throws SQLException
	{
		...
		getJdbcConnection().getSqlAdapter().retrieveProcedure(this);
	}
}
