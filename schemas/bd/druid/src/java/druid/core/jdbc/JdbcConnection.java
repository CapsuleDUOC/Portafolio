...
//===   JdbcConnection
//===
//===   Copyright (C) by Andrea Carboni. Alexandre Clavaud
...
public class JdbcConnection
{
	...
	public boolean connect(String url, String user, String password, boolean autoCommit) throws SQLException
	{
		...
		//------------------------------------------------------------------------
		//--- start executing metadata methods
	...
	public boolean disconnect( int timeout )
	{
		...
		//--- inside a thread leaves the GUI responsive
	...
	public boolean isConnected() { return ( sqlConn != null ); }

	public DatabaseMetaData getMetaData()       { return dbMetaData;      }
	public Connection       getConnection()     { return sqlConn;         }
	public DatabaseEntity   getDatabaseEntity() { return dbEntity;        }
	public int              getMaxRows()        { return iMaxRows;        }
	public String           getLog()            { return logger.getLog(); }
	public SqlAdapter       getSqlAdapter()     { return sqlAdapter;      }
	...
	public ResultSet select( String query, Vector args ) throws SQLException, IOException
	{
		...
		if ( args != null )
			for ( int i = 0; i < args.size(); i++ )
				setParam( stmt, i, args.elementAt( i ) );
