...
//		rl.newRecord();
//		rl.addToRecord("Synonyms");
//		rl.addToRecord(Boolean.TRUE);

//		rl.newRecord();
//		rl.addToRecord("User defined types");
//		rl.addToRecord(Boolean.TRUE);
	}
	...
	public boolean importTables()     { return getBoolValue(0); }
	public boolean importViews()      { return getBoolValue(1); }
	public boolean importProcedures() { return getBoolValue(2); }
	public boolean importFunctions()  { return getBoolValue(3); }
	public boolean importSequences()  { return getBoolValue(4); }
//	public boolean importSynonyms()   { return getBoolValue(5); }
//	public boolean importUDT()        { return getBoolValue(6); }
